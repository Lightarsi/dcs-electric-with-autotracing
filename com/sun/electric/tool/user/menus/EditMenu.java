...
//                    }
                ...
                new EMenu("_Selection",
                    ...
                    public void run() {
                        ...
                        SEPARATOR,
                        new EMenuItem("Make Selected Eas_y") {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        new EMenuItem("Show Single Geometry", KeyStroke.getKeyStroke(KeyEvent.VK_SLASH, 0)) {
                    public void run() {
                    ...
                    public void run() {
                        ...
                        new EMenuItem("_Remove from Waveform", KeyStroke.getKeyStroke('R', 0)) {
                    public void run() {
