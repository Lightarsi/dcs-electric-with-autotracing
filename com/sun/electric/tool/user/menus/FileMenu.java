...
//		String [] extensions = type.getExtensions();
    ...
    /**
     * This method implements the export cell command for spice with specific
     * cell Method is used in Autotracing system (5400TP035)
     */
    public static void exportCommand() {
        
        Cell cell = Automodelling.getCellFromName(Automodelling.AUTOTRACING_CELL_NAME);
        
        if(cell==null) {
            System.out.println("No cell in autotracing");
            return;
        }
        FileType type = FileType.SPICE;
...
//		String [] extensions = type.getExtensions();
        ...
        if (type == FileType.SPICE
            ...
            System.out.println("Writing job can't do it.");
        }
    }
