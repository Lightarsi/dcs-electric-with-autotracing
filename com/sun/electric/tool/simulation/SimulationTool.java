...
public class SimulationTool extends Tool {
    ...
    /**
     * Method to return the name of the current Spice parts library. The Spice
     * parts library is a library of icons that are used in Spice.
     *
    ...
    /**
     * Method to set the name of the current Spice parts library. The Spice
     * parts library is a library of icons that are used in Spice.
     *
    ...
    /**
     * Method to return the name of the default Spice parts library. The Spice
     * parts library is a library of icons that are used in Spice.
     *
